...
ScrollReveal().reveal('.main__title, .works__title, .services__title', {delay: 500, distance: '10%', origin: 'top', duration: '900'});
ScrollReveal().reveal('.main__img, .my-swiper', {delay: 700, distance: '10%', origin: 'top'});
ScrollReveal().reveal('.services__title', {delay: 500, distance: '10%', origin: 'top', duration: '900'});
